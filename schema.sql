...
CREATE TRIGGER hook01 AFTER UPDATE ON public.dialogs FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://binbtqrsriughhapnsps.functions.supabase.co/edge-hello-world', 'POST', '{"Content-type":"application/json"}', '{}', '1000');
