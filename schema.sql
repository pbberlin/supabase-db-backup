...
CREATE TABLE IF NOT EXISTS "public"."triggerhook" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT now() NOT NULL,
    "cntr" integer DEFAULT 0
);

ALTER TABLE "public"."triggerhook" OWNER TO "postgres";

ALTER TABLE "public"."triggerhook" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."triggerhook_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."triggerhook"
    ADD CONSTRAINT "triggerhook_pkey" PRIMARY KEY ("id");
...
CREATE TRIGGER hook02 AFTER UPDATE ON public.triggerhook FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://binbtqrsriughhapnsps.supabase.co/functions/v1/users', 'POST', '{"Content-type":"application/json","caller":"hook"}', '{"param1":"val1"}', '1000');

CREATE TRIGGER update_timestamp_1 BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION extensions.moddatetime('updated');

CREATE TRIGGER update_timestamp_2 BEFORE UPDATE ON public.dialogs FOR EACH ROW EXECUTE FUNCTION extensions.moddatetime('updated');

CREATE TRIGGER update_timestamp_3 BEFORE UPDATE ON public.pool FOR EACH ROW EXECUTE FUNCTION extensions.moddatetime('updated');
...
GRANT ALL ON TABLE "public"."triggerhook" TO "anon";
GRANT ALL ON TABLE "public"."triggerhook" TO "authenticated";
GRANT ALL ON TABLE "public"."triggerhook" TO "service_role";

GRANT ALL ON SEQUENCE "public"."triggerhook_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."triggerhook_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."triggerhook_id_seq" TO "service_role";
